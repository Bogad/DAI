package ma.gov.bkam.dai.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ma.gov.bkam.dai.service.EmailAlreadyUsedException ||
            ex instanceof ma.gov.bkam.dai.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof ma.gov.bkam.dai.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "ma.gov.bkam.dai");
    }
}
