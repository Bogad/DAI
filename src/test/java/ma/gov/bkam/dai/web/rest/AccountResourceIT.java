package ma.gov.bkam.dai.web.rest;

import static ma.gov.bkam.dai.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import ma.gov.bkam.dai.IntegrationTest;
import ma.gov.bkam.dai.config.Constants;
import ma.gov.bkam.dai.domain.User;
import ma.gov.bkam.dai.repository.AuthorityRepository;
import ma.gov.bkam.dai.repository.UserRepository;
import ma.gov.bkam.dai.security.AuthoritiesConstants;
import ma.gov.bkam.dai.service.UserService;
import ma.gov.bkam.dai.service.dto.AdminUserDTO;
import ma.gov.bkam.dai.service.dto.PasswordChangeDTO;
import ma.gov.bkam.dai.service.dto.UserDTO;
import ma.gov.bkam.dai.web.rest.vm.KeyAndPasswordVM;
import ma.gov.bkam.dai.web.rest.vm.ManagedUserVM;
